"""
Sistema: Gerenciamento de Deposito
Versao: 1.0.1
Desevolvedor: Felipe da Silva Braz
Licença GPLv3
Ano: 2025
Repositorio: https://github.com/FelipeSBz/SISTEMA-DE-GERENCIAMENTO-DE-DEPOSITO
"""
...
class GerenciadorDeposito:
    ...
    def registrar_entrada(self, produto_id: int, quantidade: int, 
        ...
        cursor.execute("""
            INSERT INTO movimentacoes (produto_id, tipo, quantidade, data_movimentacao, observacao)
            VALUES (?, 'ENTRADA', ?, ?, ?)
        """, (produto_id, quantidade, data_atual, observacao.upper()))
...
class InterfaceDeposito:
    def __init__(self, root):
        self.root = root
        self.root.title("Sistema de Gerenciamento de Depósito v1.0.1")
    ...
    def criar_aba_relatorios(self):
        ...
        ttk.Button(btn_frame, text="💾 Salvar Relatório", command=self.imprimir_relatorio).pack(side='left', padx=5)
    ...
    def imprimir_relatorio(self):
        ...
        if not conteudo:
            messagebox.showwarning("Atenção", "Gere um relatório antes de imprimir!")
            return
